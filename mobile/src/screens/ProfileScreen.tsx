...
const HOBBIES = [
  // Творчество и медиа
  'Музыка', 'Кино', 'Фото', 'Видео', 'Дизайн', 'Арт', 'Рисование', 'Живопись', 'Скульптура', 'DIY', 'Рукоделие',
  'Вязание', 'Вышивка', 'Моделирование', '3D-печать', 'Анимация', 'Писательство', 'Поэзия', 'Блогинг', 'Подкасты',
  // Активный отдых и спорт
  'Спорт', 'Бег', 'Велоспорт', 'Плавание', 'Йога', 'Пилатес', 'Кроссфит', 'Танцы', 'Фитнес', 'Скалолазание',
  'Лыжи', 'Сноуборд', 'Сёрфинг', 'Дайвинг', 'Пеший туризм', 'Кемпинг', 'Рыбалка', 'Охота', 'Скейтборд', 'Ролики',
  'Теннис', 'Бадминтон', 'Настольный теннис', 'Футбол', 'Баскетбол', 'Волейбол', 'Единоборства', 'Бокс', 'Шахматы',
  // Путешествия и природа
  'Путешествия', 'Горы', 'Море', 'Садоводство', 'Цветы', 'Аквариумистика', 'Птицы', 'Собаки', 'Кошки',
  // Интеллект и хобби
  'Чтение', 'Кулинария', 'Выпечка', 'Кофе', 'Чай', 'Вино', 'Настольные игры', 'Гейминг', 'Пазлы', 'Коллекционирование',
  'Программирование', 'Робототехника', 'Электроника', 'Астрономия', 'История', 'Психология', 'Философия', 'Языки',
  'Медитация', 'Массаж', 'Уход за собой', 'Мода', 'Шопинг', 'Авто', 'Мото', 'Велотуризм',
  // Социальное
  'Волонтёрство', 'Нетворкинг', 'Караоке', 'Инструмент', 'Театр', 'Музеи', 'Концерты', 'Фестивали',
];
